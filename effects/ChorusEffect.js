...
export class ChorusEffect extends AbstractEffectNode {
    constructor(audioContext) {
        ...
        this.depthRange.gain.value = 0.003;
        ...
        this.depthRange.connect(this.delayNode.delayTime);
        this.lfo.start();
    ...
    getConfigSchema() {
        return {
            ...
            depth: {
                ...
                max: 1,
                step: 0.01,
                value: this.lfoGain.gain.value / 0.03,
            },
        };
    }
